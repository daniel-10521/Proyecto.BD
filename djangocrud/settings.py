...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://basededatsonube_user:o2HK0cfwGrjWcVjkG0NDDO7BGNMLorhs@dpg-d5t437ili9vc73cvtd1g-a/basededatsonube',
        conn_max_age=600
    )
}
...
# Esta configuración es vital para Render
if not DEBUG:
    STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
    STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'