...
# --- CAMBIO 1: AGREGAMOS TUS NUEVOS MODELOS AQUÍ ---
from .models import Task, Perfil, Experiencia, Curso 
...
# --- CAMBIO 2: ESTA ES LA VISTA QUE CONECTA TU CV A LA BASE DE DATOS ---
def home(request):
    # Buscamos el primer perfil que exista en la base de datos
    perfil = Perfil.objects.first() 
    # Buscamos todas las experiencias
    experiencias = Experiencia.objects.all()
    # Buscamos todos los cursos
    cursos = Curso.objects.all()

    # Enviamos todo al HTML en un diccionario
